...
$userCount = ($result && $result->num_rows > 0) ? $result->fetch_assoc()['user_count'] : 0;
...
<body>
  <div class="sidebar">
    <div class="sidebar-header"><h2>Gym Admin</h2></div>
  ...
  <div class="main-content">
    ...
    <div class="container">
      <div class="admin-panel">
        ...
        <p>Welcome to the Gym Management System Admin Panel.</p>
        <div class="panel-links">
          <a href="users.php" class="panel-link"><i class="fas fa-users"></i> Manage Users</a>
          <a href="attendance.php" class="panel-link"><i class="fas fa-check-circle"></i> View Attendance</a>
          <a href="report.php" class="panel-link"><i class="fas fa-chart-line"></i> View Reports</a>
          <a href="payment.php" class="panel-link"><i class="fas fa-credit-card"></i> View Payments</a>
          <a href="settings.php" class="panel-link"><i class="fas fa-cogs"></i> Settings</a>
        </div>
      </div>
      <div class="user-count">
        <div style="text-align: center; padding: 20px; background: #f7f9fc; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); max-width: 300px; margin: 20px auto;">
          <h3 style="margin: 0;">Total Registered Users</h3>
          <p style="font-size: 2rem; color: #007bff; font-weight: bold; margin-top: 10px;"><?php echo $userCount; ?></p>
        </div>
      </div>
